...
* [ish](https://github.com/ish-app/ish) ⭐ 20,345 | 🐛 702 | 🌐 C | 📅 2026-07-27. A project to get a Linux shell running on iOS, using usermode x86 emulation and syscall translation.

* [ipatool](https://github.com/majd/ipatool) ⭐ 9,869 | 🐛 31 | 🌐 Go | 📅 2026-08-03

* [idb-facebook](https://github.com/facebook/idb/) ⭐ 5,286 | 🐛 181 | 🌐 Swift | 📅 2026-08-20. Tool for replacing WebDriverAgent.

* [WebDriverAgent](https://github.com/facebookarchive/WebDriverAgent) ⚠️ Archived. Archive.

* [frida-ios-dump](https://github.com/AloneMonkey/frida-ios-dump) ⭐ 3,917 | 🐛 107 | 🌐 JavaScript | 📅 2023-05-03 Pull a decrypted IPA from a jailbroken device
...
* [bagbak](https://github.com/ChiChou/bagbak) ⭐ 1,489 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-24. Yet another frida based iOS dumpdecrypted. Also decrypts app extensions
...
* [libimobiledevice](https://github.com/libimobiledevice/libimobiledevice) ⭐ 8,121 | 🐛 848 | 🌐 C | 📅 2026-06-10 A library to communicate with services on iOS devices using native protocols.
...
* [ipsw](https://github.com/blacktop/ipsw) ⭐ 3,653 | 🐛 7 | 🌐 Go | 📅 2026-08-20. iOS/macOS Research Swiss Army Knife

* [idevicerestore](https://github.com/libimobiledevice/idevicerestore) ⭐ 1,914 | 🐛 331 | 🌐 C | 📅 2026-06-26 A command-line application to restore firmware files to iOS devices.
...
* [libusbmuxd](https://github.com/libimobiledevice/libusbmuxd) ⭐ 685 | 🐛 31 | 🌐 C | 📅 2025-09-07 A client library for applications to handle usbmux protocol connections with iOS devices.
...
* [jtool.ELF64](https://github.com/MobSF/Mobile-Security-Framework-MobSF/blob/master/mobsf/StaticAnalyzer/tools/ios/jtool.ELF64) ⭐ 21,616 | 🐛 21 | 🌐 JavaScript | 📅 2026-08-17
* [apfs-fuse](https://github.com/sgan81/apfs-fuse) ⭐ 2,135 | 🐛 125 | 🌐 C++ | 📅 2024-08-13
...
* [objection](https://github.com/sensepost/objection) ⭐ 9,332 | 🐛 55 | 🌐 Python | 📅 2026-07-23 objection is a runtime mobile exploration toolkit, powered by Frida, built to help you assess the security posture of your mobile applications, without needing a jailbreak.

* [reFlutter](https://github.com/Impact-I/reFlutter) ⭐ 2,735 | 🐛 10 | 🌐 Python | 📅 2026-08-11. reFlutter.
...
* [frida-ios-hook](https://github.com/noobpk/frida-ios-hook) ⭐ 1,178 | 🐛 4 | 🌐 JavaScript | 📅 2026-05-05. A script that helps you trace classes, functions, and modify the return values of methods on iOS platform.

* [frida-ios-hook](https://github.com/noobpk/frida-ios-hook) ⭐ 1,178 | 🐛 4 | 🌐 JavaScript | 📅 2026-05-05. A tool that helps you easy trace classes, functions, and modify the return values of methods on iOS platform.
...
* [MobSf](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,616 | 🐛 21 | 🌐 JavaScript | 📅 2026-08-17
...
* [RE-iOS-Apps](https://github.com/ivRodriguezCA/RE-iOS-Apps) ⭐ 2,896 | 🐛 2 | 📅 2024-04-17
