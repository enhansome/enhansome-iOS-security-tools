...
* [ish](https://github.com/ish-app/ish) ⭐ 20,354 | 🐛 701 | 🌐 C | 📅 2026-08-22. A project to get a Linux shell running on iOS, using usermode x86 emulation and syscall translation.

* [ipatool](https://github.com/majd/ipatool) ⭐ 9,884 | 🐛 32 | 🌐 Go | 📅 2026-08-03

* [idb-facebook](https://github.com/facebook/idb/) ⭐ 5,291 | 🐛 181 | 🌐 Swift | 📅 2026-08-23. Tool for replacing WebDriverAgent.
...
* [bagbak](https://github.com/ChiChou/bagbak) ⭐ 1,493 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-24. Yet another frida based iOS dumpdecrypted. Also decrypts app extensions
...
* [libimobiledevice](https://github.com/libimobiledevice/libimobiledevice) ⭐ 8,126 | 🐛 848 | 🌐 C | 📅 2026-06-10 A library to communicate with services on iOS devices using native protocols.
...
* [ipsw](https://github.com/blacktop/ipsw) ⭐ 3,655 | 🐛 7 | 🌐 Go | 📅 2026-08-23. iOS/macOS Research Swiss Army Knife
...
* [ideviceinstaller](https://github.com/libimobiledevice/ideviceinstaller) ⭐ 1,445 | 🐛 67 | 🌐 C | 📅 2025-10-30 A command-line application to manage apps and app archives on iOS devices.

* [ifuse](https://github.com/libimobiledevice/ifuse) ⭐ 1,014 | 🐛 61 | 🌐 C | 📅 2026-04-22 A fuse filesystem implementation to access the contents of iOS devices.
...
* [libirecovery](https://github.com/libimobiledevice/libirecovery) ⭐ 650 | 🐛 47 | 🌐 C | 📅 2026-08-23 The libirecovery library allows communication with iBoot/iBSS of iOS devices via USB.
...
* [libideviceactivation](https://github.com/libimobiledevice/libideviceactivation) ⭐ 358 | 🐛 18 | 🌐 C | 📅 2025-09-07 A library to manage the activation process of Apple iOS devices.
...
* [jtool.ELF64](https://github.com/MobSF/Mobile-Security-Framework-MobSF/blob/master/mobsf/StaticAnalyzer/tools/ios/jtool.ELF64) ⭐ 21,625 | 🐛 24 | 🌐 JavaScript | 📅 2026-08-21
...
* [objection](https://github.com/sensepost/objection) ⭐ 9,339 | 🐛 55 | 🌐 Python | 📅 2026-07-23 objection is a runtime mobile exploration toolkit, powered by Frida, built to help you assess the security posture of your mobile applications, without needing a jailbreak.
...
* [frida-ios-hook](https://github.com/noobpk/frida-ios-hook) ⭐ 1,179 | 🐛 4 | 🌐 JavaScript | 📅 2026-05-05. A script that helps you trace classes, functions, and modify the return values of methods on iOS platform.

* [frida-ios-hook](https://github.com/noobpk/frida-ios-hook) ⭐ 1,179 | 🐛 4 | 🌐 JavaScript | 📅 2026-05-05. A tool that helps you easy trace classes, functions, and modify the return values of methods on iOS platform.
...
* [MobSf](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,625 | 🐛 24 | 🌐 JavaScript | 📅 2026-08-21
...
* [RE-iOS-Apps](https://github.com/ivRodriguezCA/RE-iOS-Apps) ⭐ 2,898 | 🐛 2 | 📅 2024-04-17
